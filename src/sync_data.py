...
devices = (
    ...
    Device("S1_ENV_TEMPERATURE", out_path="out/S2/env_temperature"),
    Device("S1_ENV_PRESSURE", out_path="out/S2/env_pressure"),
    Device("S1_ENV_GAS", out_path="out/S2/env_gas"),
    Device("S1_ENV_ALTITUDE", out_path="out/S2/env_altitude"),
    Device("S1_ENV_HUMIDITY", out_path="out/S2/env_humidity"),
    Device("S1_LIGHT", out_path="out/S2/light"),
    Device("S1_CO2", out_path="out/S2/co2"),
    Device("S2_RADAR", out_path="out/S1/radar"),
    Device("S2_ENV_TEMPERATURE", out_path="out/S1/env_temperature"),
    Device("S2_ENV_PRESSURE", out_path="out/S1/env_pressure"),
    Device("S2_ENV_GAS", out_path="out/S1/env_gas"),
    Device("S2_ENV_ALTITUDE", out_path="out/S1/env_altitude"),
    Device("S2_ENV_HUMIDITY", out_path="out/S1/env_humidity"),
    Device("S2_LIGHT", out_path="out/S1/light"),
    Device("S2_CO2", out_path="out/S1/co2"),
    # outputs
